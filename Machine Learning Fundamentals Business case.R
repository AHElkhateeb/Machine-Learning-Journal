...
stores_tbl      <- read_excel(path  = "Machine Learning Fundamentals data/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Store Lookup",
                              skip  = 1)
products_tbl    <- read_excel(path  = "Machine Learning Fundamentals data/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Products Lookup",
                              skip  = 1)
transaction_tbl <- read_excel(path  = "Machine Learning Fundamentals data/breakfast_at_the_frat.xlsx",
...
umap_kmeans_3_results_tbl %>%
  ...
  # Formatting
  scale_color_manual(values=c("#2d72d6", "#8B008B", "#FFA500")) +
...
# Cluster 1
  ...
  umap_kmeans_3_results_tbl %>%
    ...
    ggplot(aes(x, y, color = .cluster)) #NOT COMPLETE